          ...
          <div className="mt-6 p-5 rounded-xl bg-gradient-to-br from-accent/10 to-transparent border border-accent/20 backdrop-blur-sm">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-[#4267B2]/10 hover:bg-[#4267B2]/20 border-[#4267B2]/30 hover:border-[#4267B2] text-[#4267B2] font-medium smooth-transition"
                onClick={() => {
                  const url = `https://ai.democracy.earth/vote/${electionId}`;
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-[#0A66C2]/10 hover:bg-[#0A66C2]/20 border-[#0A66C2]/30 hover:border-[#0A66C2] text-[#0A66C2] font-medium smooth-transition"
                onClick={() => {
                  const url = `https://ai.democracy.earth/vote/${electionId}`;
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-[#25D366]/10 hover:bg-[#25D366]/20 border-[#25D366]/30 hover:border-[#25D366] text-[#25D366] font-medium smooth-transition"
                onClick={() => {
                  const url = `https://ai.democracy.earth/vote/${electionId}`;
                  const text = `Vote on: ${election.title}`;
